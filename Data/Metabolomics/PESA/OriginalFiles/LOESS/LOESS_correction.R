...
basePath <- "S:\\U_Proteomica\\UNIDAD\\software\\MacrosRafa\\data\\Metabolomics\\PESA_Integromics\\Data\\Metabolomics\\PESA\\OriginalFiles"
mode <- "HILP" # C18N, C18P, HILN, HILP

for (mode in c('C18N', 'C18P', 'HILN', 'HILP')) {
...
samFile <- read_excel(
  path=file.path(basePath, 'RBR_PESA_V1.xlsx'),
  sheet=mode
)
